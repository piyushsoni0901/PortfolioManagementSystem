			...
			<div class="col-sm-6 ">
				<div class="card text-center shadow-lg">
					<img class="card-img-top img-fluid"
						src="https://cdn.corporatefinanceinstitute.com/assets/net-worth-1024x683.jpeg"
						style="width: 600x; height: 300px;" alt="Card image cap">
					<div class="card-block ">
						<h3 class="card-title mt-3">Calculate Networth</h2>
						
						<h4 class="card-text">Your Networth is : ${networth}</h4>
						<br> 
